...
export const pipelines = {
  ...
  generate: (source: string, target: string, description: string) => api.post<any>(`/pipelines/generate`, { source, target, description }),
  approveProposal: (id: string) => api.post<any>(`/pipelines/proposals/${id}/approve`),
  rejectProposal: (id: string) => api.post<any>(`/pipelines/proposals/${id}/reject`),
