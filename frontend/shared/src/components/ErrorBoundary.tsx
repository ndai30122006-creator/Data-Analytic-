      ...
      return (
        <div style={{ padding: 24, textAlign: "center", maxWidth: 480, margin: "40px auto", border: "1px solid rgba(239,68,68,0.3)", borderRadius: 12, background: "rgba(239,68,68,0.06)" }}>
          ...
          <div style={{ marginTop: 12, display: "flex", gap: 8, justifyContent: "center" }}>
            <button onClick={this.handleReset} style={{ padding: "8px 14px", background: "var(--accent)", color: "#fff", border: 0, borderRadius: 4, cursor: "pointer" }}>Thử lại</button>
            <button onClick={() => (window.location.href = "/")} style={{ padding: "8px 14px", background: "rgba(255,42,109,0.08)", color: "var(--text)", border: "1px solid var(--border)", borderRadius: 4, cursor: "pointer" }}>Về trang chủ</button>
          </div>
        </div>
      );
    }
